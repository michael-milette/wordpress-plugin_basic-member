...
class BasicMember_LifeCycle extends BasicMember_InstallIndicator {
    ...
    public function activate() {
        // Clone subscriber role into new subscriber+ role.
        $subscriber = get_role( 'subscriber' );
        add_role( 'subscriber+', 'Subscriber+', $subscriber->capabilities );
    }
    ...
    protected function otherUninstall() {
        // We don't delete the Subscriber Plus role because we
        // don't want to loose user association with the role.
        // Example: Temporarily disabling the plugin.
    }
